document.addEventListener('DOMContentLoaded', () => {
  ...
  // 作品数据 (30个项目)
    const projects = [
        ...
        { category: 'ui', title: 'Mobile App UI', description: 'User interface design for a fitness tracking mobile application, focusing on intuitive navigation and clean aesthetics.', date: '2023', image: '/path/to/another-graphic-design-image.jpg' },
        ...
        { category: 'ui', title: 'Dashboard Design', description: 'UI design for a data analytics dashboard, focusing on usability and data visualization.', date: '2023', image: '/path/to/another-graphic-design-image.jpg' },
